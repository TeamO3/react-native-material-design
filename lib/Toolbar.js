...
export default class Toolbar extends Component {
    ...
    render() {
        const { title, theme, primary, style, leftIconStyle, rightIconStyle, elevation, overrides, icon, onIconPress, actions, onLayout, titleStyle } = this.props;
                            ...
                            >
                              {(action.icon) ?
                                ...
                                <View style={{padding: 16, alignItems: 'center', justifyContent: 'center'}}>
                                  <Text style={{color: 'white', fontSize: 14}}>{action.title}</Text>
                                </View>
